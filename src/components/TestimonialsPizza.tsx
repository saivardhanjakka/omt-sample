...
export default function TestimonialsPizza() {
  //const [currentSlide, setCurrentSlide] = useState(0);

  const testimonials = [
    {
      id: 1,
      image: "/assets/dipen-patel-puffiza_pizzeria.avif",
      quote:

      "Puffiza has more than 20 outlets across Gujarat. And to maintain quality and consistency across all outlets, we needed a system that helped us create a centralised kitchen and automate the flow of raw materials. This automation has been possible with Petpooja’s inventory management system.",
      name: "Dipen Patel,",
      title: "Owner",
      logo: "puffiza",
      logoImage: "/assets/puffiza.avif",
    },
  ];
