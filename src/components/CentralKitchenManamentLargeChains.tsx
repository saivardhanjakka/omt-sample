...
export default function CentralKitchenManagementLargeChains() {
  return (
...
Operate your outlet’s kitchen in any city and supply raw material or semi-cooked items using our central kitchen module          </p>
...
With Petpooja POS, you can get ‘low stock alerts’ for any outlet and supply stock whenever needed              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-900 text-base md:text-lg">
Generate a consolidated route plan, every time your outlet raises purchase orders at your central kitchen              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2">
          <Image
            src="/assets/Central-Kitchen-Management_lg (1).avif"
