    ...
    <section className="w-full bg-white overflow-x-hidden">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        <div className="flex flex-col lg:flex-row items-center py-6 sm:py-8 lg:py-12 xl:py-16 min-h-[400px] lg:min-h-[500px]">
          {/* Left Column - Content */}
          <div className="w-full lg:w-1/2 text-center lg:text-left lg:pr-10 lg:ml-20 xl:pr-12 animate-slide-in-from-left">
            ...
            <p className="mt-4 lg:mt-5 text-lg sm:text-base lg:text-base xl:text-lg text-gray-600 max-w-sm lg:max-w-md mx-auto lg:mx-0 leading-relaxed">
              Petpooja's CRM allows you to track, manage, and reward loyal
              customers, ensuring that your brand creates a special relationship
              with every customer
            </p>
          ...
          <div className="relative w-full lg:w-1/2 flex justify-center items-center mt-6 lg:mr-20 lg:mt-0 animate-slide-in-from-right">
            <img
              src="/assets/crm-hero_lg.avif"
