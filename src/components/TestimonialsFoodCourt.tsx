...
export default function TestimonialsFoodCourt() {
  //const [currentSlide, setCurrentSlide] = useState(0);

  const testimonials = [
    {
      id: 1,
      image: "/assets/Sai-Sumanth-Chedella_md.avif",
      quote:
"Petpooja's integrations, support, ease, updates, and reliability have made us more reliant. Thanks to petpooja, we make more informed decisions now.",
      name: "Sai Sumanth Chedella",
      title: "Director",
      logo: "Sai_Radhika_Food",
      logoImage: "/assets/Sai_Radhika_Food.avif",
    },
