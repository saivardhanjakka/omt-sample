...
// import image from "../../public/assets/hero-imageupdated.png"
...
//               Transform your food business with Ordermatic, the ultimate
//               cloud-based solution to elevate your customer experiences and
//               boost your business
//             </p>
    ...
    <section className="w-full bg-white overflow-x-hidden lg:-mt-2">
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        <div className="flex flex-col lg:flex-row items-center py-6 sm:py-8 lg:py-12 xl:py-16 min-h-[400px] lg:min-h-[500px] gap-4 lg:gap-2">
          ...
          {/* Left Column - Unified Content */}
          <div className="w-full lg:w-1/2 text-center lg:text-left lg:pl-14 animate-slide-in-from-left">
            <h1 className="text-3xl sm:text-4xl lg:text-[3.5rem] font-bold leading-tight text-gray-800">
              Advanced POS & Billing Software
            </h1>

            <p className="mt-4 text-sm sm:text-base lg:text-xl text-gray-600 max-w-xl mx-auto lg:mx-0 leading-relaxed">
              Transform your food business with Ordermatic, the ultimate
              cloud-based solution to elevate your customer experiences and
              boost your business.
            </p>

            <div className="mt-5 lg:mt-8 flex justify-center lg:justify-start">
              <Button
                size="default"
                className="bg-[#F47537] hover:bg-[#F47537] text-white h-10 lg:h-11 px-6 text-md font-semibold"
                onClick={handleScrollToForm}
              >
                Book a Free Demo
              </Button>
