...
export default function PayrollForm() {
  ...
  return (
    <div className="relative " id="PayrollForm">
      ...
      <div className="absolute top-[45%] left-0 w-full h-[55%] bg-[#09151F] z-0" />
      <div className="absolute bottom-[70%]  left-0 w-full h-[30%] bg-[#EBF6FD] hidden lg:block z-0"  />
              ...
              <div className="pt-0 font-quicksand">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end pt-4">
                    <Button
                      type="submit"
                      className="bg-[#0084d9] text-center text-white px-8 py-6 mr-10 mb-6 text-lg rounded-2xl transition-colors"
                    >
                      Submit
                    </Button>
                  </div>
