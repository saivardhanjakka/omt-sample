...
export default function TestimonialsLargeChains() {
  //const [currentSlide, setCurrentSlide] = useState(0);

  const testimonials = [
    {
      id: 1,
      image: "/assets/Kabir-adwani_md.avif",
      quote:

      "To run multiple outlets, you need a technological solution that perfectly syncs with all other processes and is all well-integrated into one for smooth restaurant operations. I think here Petpooja has done a phenomenal job in helping us do that",
      name: "Kabir Advani",
      title: "Managing Partner",
      logo: "bercos-testimonial",
      logoImage: "/assets/bercos-testimonial.avif",
    },
