          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="relative">
              <div className="relative rounded-lg overflow-hidden">
                <Image
                  src="/assets/Inventory-Reports-cafe_lg.avif"
            ...
            <div className="mt-8 lg:mt-0">
              <Image
                src="/assets/Customer-Analytics-cafe_lg.avif"
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-8 text-lg">
                With Petpooja POS, you will never have to deny a customer’s
                request for croissants or deal with the horror of serving them
                with stale bagels!
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-300">
                  Download detailed reports about inventory procurement, its expenses & tally them against your sales
