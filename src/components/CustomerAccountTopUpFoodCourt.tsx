...
export default function FoodCourtCustomerAccount() {
  return (
...
The one-stop billing solution for all your counters’ need
  </h2>

  <p className="text-lg md:text-xl text-gray-600 mt-4 max-w-2xl mx-auto">
Set multiple billing counters & different pickup stations while allocating inventory as per the counters’ needs
  </p>
</div>
      ...
      <div className="mt-12 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-900 mt-6 md:mt-0 whitespace-nowrap md:whitespace-normal">
            <span className="text-gray-800">Customer Account Top-up & Redemption</span>
          </h3>
