...
export function RestaurantMenuManagementHeroSection() {
    ...
    <section className="w-full bg-white overflow-x-hidden mt-10">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-20">
        <div className="flex flex-col lg:flex-row items-center py-6 sm:py-8 lg:py-12 xl:py-16 min-h-[400px] lg:min-h-[500px]">
          {/* Left Column - Content */}
          <div className="w-full lg:w-1/2 text-center lg:text-left lg:ml-20 lg:pr-10 xl:pr-12 animate-slide-in-from-left">
            {/* Mobile heading with breaks */}
            <h1 className="block md:hidden text-3xl sm:text-xl  leading-tight text-gray-800">
            ...
            <p className="mt-6 lg:mt-5 text-lg sm:text-sm lg:text-base xl:text-lg text-gray-600 max-w-sm lg:max-w-md mx-auto lg:mx-0 leading-relaxed">
          ...
          <div className="relative w-full lg:w-1/2 flex justify-center lg:mr-20 items-center mt-8 lg:mt-0 animate-slide-in-from-right">
            <img
              src="/assets/menu-hero.avif"
