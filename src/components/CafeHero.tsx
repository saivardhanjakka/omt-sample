...
export function CafeHeroSection() {
  return (
          ...
          an expresso shot!
            ...
            <h1 className="hidden md:block px-16 lg:hidden text-4xl font-bold leading-tight text-gray-800">
               A cafe POS as strong as  an expresso shot!
                ...
                <p  className="font-bold mt-4 lg:mt-5 text-lg sm:text-base lg:text-lg xl:text-lg text-red-800 max-w-sm lg:max-w-md mx-auto lg:mx-0 leading-relaxed">CAFE</p>
