...
export default function InventoryManagementFineDineIn() {
  return (
    <section className="bg-white px-4 md:px-20 py-6 overflow-x-hidden max-w-screen">
      <div className="mt-12 flex flex-col lg:flex-row items-center gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2">
          <Image
            src="/assets/inventory-management-fine-dine_lg.avif"
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="mt-4 lg:mt-5 text-gray-700 text-base md:text-lg leading-relaxed lg:leading-8 max-w-none lg:max-w-xl">
            Butter chicken without chicken is a disaster! Petpooja's restaurant
            inventory system helps you take orders as per stock availability
            while monitoring the consumption rate of those expensive raw
            materials
          </p>
