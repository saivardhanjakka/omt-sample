...
export function PizzeriaHeroSection() {
  return (
    <section className="w-full bg-white">
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:pl-36">
        ...
        Pizza lovers always want extra. Meet their demands by merging all your operations on a single dashboard{" "}
            </p>
          ...
          <div className="relative w-full lg:w-1/2 flex justify-center items-center mt-6 lg:mt-0">
            <img
              src="/assets/Pizzeria-hero_md.avif"
              alt=""
