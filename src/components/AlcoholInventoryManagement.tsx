...
export default function AlcohalInventoryMangement() {
  return (
...
Your nightmare of recording & managing inventory manually gets completely automated with Petpooja bar POS!          </p>
...
Record liquor stock in an item-wise inventory              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-900 text-base md:text-lg">
Track consumption rate, pilferage and other expenses              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2">
          <Image
            src="/assets/alcohol-inventory-management_lg.avif"
