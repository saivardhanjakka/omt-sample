...
const features = [
  {
    ...
    description:
      "A POS system that provides you with the complete picture of your online order sales, aggregator commissions, and much more",
    image: "/assets/online-ordering.avif",
  ...
  },
  {
    ...
    alt: "Billing Software icon",
    href: "/poss/restaurant-billing-software",
    isAbsolute: true,
  },
];

export default function CrmPosSystem() {
  useEffect(() => {
    Aos.init({ once: true });
  }, []);

  return (
    <div className="bg-gray-50 py-16 md:py-24 overflow-x-hidden overflow-y-hidden">
      <div className="max-w-7xl mx-auto px-6 md:px-6">
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {features.map((feature, index) => (
            <div
              key={index}
              className="relative bg-white rounded-lg p-8 shadow-sm hover:shadow-md hover:bg-[#F47537] transition-all duration-300 group h-96 cursor-pointer animate-slide-in-from-bottom"
