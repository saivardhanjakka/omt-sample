...
export default function QsrCategoryKot() {
  return (
      ...
      <div className="mt-12 flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2">
          <h3 className="text-2xl md:text-3xl lg:text-4xl font-semibold text-gray-900 mt-6 md:mt-0 whitespace-nowrap md:whitespace-normal">
            <span className="text-gray-800">Category-wise KOTs</span>
          </h3>

          <p className="mt-4 lg:mt-5 text-gray-700 text-base md:text-lg leading-relaxed lg:leading-8 max-w-none lg:max-w-xl">
          With Petpooja restaurant POS software, you can print separate KOTs for your food and beverage stations to avoid order mismanagement
          </p>
          ...
          <div className="mt-6 space-y-4">
            <div className="flex items-start gap-3">
             ...
             Separate KOTs to ensure no one station or biller is overworked
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-700 text-base md:text-lg">
               Use KDS to simplify order management for your kitchen staff
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2">
          <Image
            src="/assets/customer-Analytics_lg.avif"
