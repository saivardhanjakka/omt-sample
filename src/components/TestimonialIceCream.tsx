...
export default function TestimonialsIceCream() {
  //const [currentSlide, setCurrentSlide] = useState(0);

  const testimonials = [
    {
      id: 1,
      image: "/assets/gurpreet-singh_gianis_md.avif",
      quote:
"My staff loves the easy-to-use interface. They smoothly manage all the third-party integration on a single screen, increasing our efficiency significantly.",
      name: "Gurpreet Singh,",
