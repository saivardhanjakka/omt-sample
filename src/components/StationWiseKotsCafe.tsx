...
export default function StationWiseKotsCafe() {
  return (
    <section className="bg-white px-4 md:px-20 py-6 overflow-x-hidden max-w-screen">
     ...
     Station-Wise KOTs
        ...
        Don’t overwork one billing counter! Use Petpooja POS to create separate billing stations for your food and beverages for faster customer service
          ...
          Separate KOTs printing ensures no one captain or biller is overworked
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-900 text-base md:text-lg">
         Station-wise KOTs simplify customer order management for the kitchen staff 
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="w-full lg:w-1/2">
          <Image
            src="/assets/Station-Wise-KOTs_lg.avif"
