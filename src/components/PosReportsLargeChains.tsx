...
export default function PosReportsLargeChains() {
  return (
          ...
          <div className="grid lg:grid-cols-2 gap-8 lg:gap-12 items-start">
            ...
            <div className="relative">
              <div className="relative rounded-lg overflow-hidden">
                <Image
                  src="/assets/Multiple-Outlet-Reports_lg (1).avif"
          ...
          <div className="grid md:grid-cols-2 gap-12 lg:gap-16">
            ...
            <div>
              ...
              <p className="text-gray-300 mb-8 text-lg">
                With Petpooja restaurant POS software, you can manage and
                acquire data of all your outlets on a single screen{" "}
              </p>
              ...
              <div className="space-y-6">
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-300">
                    Get a simplified picture of your operations without digging
                    into boring & cumbersome reports
                  </p>
                </div>
                <div className="flex items-start space-x-4">
                  <BarChart3 className="w-6 h-6 text-white mt-1 flex-shrink-0" />
                  <p className="text-gray-300">
                    Download outlet-wise reports on sales, inventory, online
                    orders, staff performance and much more!
                  </p>
                </div>
              </div>
            </div>
            ...
            <div>
              ...
              <p className="text-gray-300 mb-8 text-lg">
                Manage all your brand outlets from anywhere, any time and have
                complete control over what your staff sees and does
              </p>
              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start space-x-4">
                  ...
                  <p className="text-gray-300">
                    Create outlet-wise staff rights & get detailed reports for
                    all the operations
                  </p>
                </div>
              </div>
