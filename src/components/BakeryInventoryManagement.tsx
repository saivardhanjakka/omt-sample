...
export default function BakeryInventoryManagement() {
  return (
      ...
      <div className="mt-12 flex flex-col-reverse lg:flex-row items-center gap-8 lg:gap-12">
        ...
        <div className="w-full lg:w-1/2">
          ...
          <p className="mt-4 lg:mt-5 text-gray-700 text-base md:text-lg leading-relaxed lg:leading-8 max-w-none lg:max-w-xl">
            Petpooja's inventory management system records item-wise inventory
            and tracks the consumption rate so that you never run out of your
            secret ingredients
          </p>
          ...
          <div className="mt-6 space-y-4">
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-900 text-base md:text-lg">
                The POS tracks your inventory expiry dates, wastage and
                pilferage
              </p>
            </div>
            ...
            <div className="flex items-start gap-3">
              ...
              <p className="text-gray-900 text-base md:text-lg">
                Analyse inventory consumption data with detailed Petpooja bakery
                POS reports
              </p>
            </div>
          </div>
        ...
        <div className="w-full lg:w-1/2">
          <Image
            src="/assets/inventory-management-bakery_lg.avif"
