...
import TaskFooter from "./TasksFooter"
...
export default function TasksForm() {
  ...
  return (
    <div className="relative   lg:mt-10" id="TaskForm">
      ...
      <div className="absolute top-[45%] left-0 w-full  h-[55%] bg-[linear-gradient(97.85deg,_#0b130c,_#0a1f0d)] z-0" />
          ...
          <div className="w-full max-w-sm sm:max-w-3xl  md:max-w-4xl lg:max-w-7xl rounded-2xl shadow-[0_4px_20px_4px_rgba(0,0,0,0.08)] p-4 sm:p-6 md:p-8 lg:p-12 relative z-20 bg-white">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 lg:gap-12 mt-6 items-start">
              ...
              <div className="lg:pt-2 max-w-xl mx-auto text-center lg:text-left">
               ...
               <h1 className="text-3xl sm:text-4xl lg:text-6xl lg:-mt-6 lg:ml-3 font-semibold text-gray-900 mb-4 leading-tight sm:leading-snug lg:leading-[1.1] sm:max-w-xs sm:mx-auto lg:max-w-full md:max-w-[20ch]">
  Your all-in-one solution for task management
</h1>

                {/* Paragraph text color reverted to gray-600 */}
                <p className="text-gray-600 text-md leading-relaxed lg:ml-3 md:text-center lg:text-left">
              Boost productivity and Collaboration across your team
                </p>
              </div>
              ...
              <div className="pt-0 font-quicksand">
                <form onSubmit={handleSubmit} className="space-y-4">
                  ...
                  <div className="flex justify-end pt-4">
                    <Button
                      type="submit"
                      className="bg-[#0ca531] text-center text-white px-8 py-6 lg:mt-2 mr-10 mb-6 text-lg rounded-2xl transition-colors"
                    >
                      Submit
                    </Button>
                  </div>
