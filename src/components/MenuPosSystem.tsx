...
export default function MenuPosSystem() {
  useEffect(() => {
    Aos.init({ once: true });
  }, []);
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-6">
        ...
        <div className="text-center mb-16 md:mb-20">
          ...
          <p className="text-lg text-gray-600 max-w-4xl mx-auto leading-relaxed">
            Petpooja is the all-in-one restaurant billing POS system that
            handles all your operations on a single screen.
          </p>
        </div>
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-12">
          {features.map((feature, index) => (
            <div
              ...
              } bg-white rounded-lg p-8 shadow-sm hover:shadow-md hover:bg-[#F47537] transition-all duration-300 group h-96 cursor-pointer animate-slide-in-from-right`}
